...
Sos Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 42400.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 42401 for connections and services them.
...
However, in open source software such as Sos Core, where everyone uses
...
pay attention to for reviewers of Sos Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sos Core uses tinyformat, which is type safe. Leave them out to avoid confusion

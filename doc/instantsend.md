...
This mechanism has been integrated into Bitcore-Node-Sos which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sospay/insight-api-sos#web-socket-api](https://github.com/sospay/insight-api-sos#web-socket-api) 
* API: [https://github.com/sospay/insight-api-sos#instantsend-transactions](https://github.com/sospay/insight-api-sos#instantsend-transactions) 
...
By default, the Sos Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sos Core daemon:

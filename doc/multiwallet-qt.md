...
Only requiring some minor changes is sos.cpp.
...
Changes to sos.cpp
----------------------
sos.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

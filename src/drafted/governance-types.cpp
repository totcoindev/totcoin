...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SosNetwork") type = SosNetwork;
    if(strType == "SosNetworkVariable") type = SosNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SosNetwork) s = "SosNetwork";
    if(type == SosNetworkVariable) s = "SosNetworkVariable";

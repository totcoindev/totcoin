    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sos: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sos Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sos Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sos addresses"));
    ...
    openAction->setStatusTip(tr("Open a sos: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sos Core help message to get a list with possible Sos Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sos Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sos network", "", count));
}
...
{
    QString strTitle = tr("Sos Core"); // default title

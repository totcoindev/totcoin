    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SOS-light"), QVariant("light"));
    ui->theme->addItem(QString("SOS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SOS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SOS-traditional"), QVariant("trad"));

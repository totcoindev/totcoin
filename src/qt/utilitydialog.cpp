    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sos Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sos Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sos-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sos in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SOS, 0.1 SOS, 1 SOS and 10 SOS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sospay.atlassian.net/wiki/display/DOC/PrivateSend\">https://sospay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sos Core is shutting down...") + "<br /><br />" +
